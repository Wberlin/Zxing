...
import com.wbl.library.decoding.CaptureActivityHandler;
import com.wbl.library.decoding.InactivityTimer;
import com.wbl.library.permission.PermissionListener;
import com.wbl.library.permission.PermissionManager;
import com.wbl.library.view.ViewfinderView;


import java.io.IOException;
import java.util.Vector;

public class QRCodeScanActivity extends Activity implements Callback, View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        helper = PermissionManager.with(this)
                //添加权限请求码
                .addRequestCode(QRCodeScanActivity.REQUEST_CODE_CAMERA)
                //设置权限，可以添加多个权限
                ...
                .setPermissionsListener(new PermissionListener() {
                    ...
                    public void onGranted() {
                        //当权限被授予时调用
//                        Toast.makeText(QRCodeScanActivity.this, "Camera Permission granted",Toast.LENGTH_LONG).show();
                    }

...
import com.wbl.library.decoding.DecodeFormatManager;
...
public class DecodeImageThread extends Thread{
    ...
    DecodeImageThread(ImageDecodeManager imageDecodeManager,
    ...
    public void run() {
        Looper.prepare();
        handler=new DecodeImageHandler(imageDecodeManager,hints);
        //释放阻塞线程

...
import com.wbl.library.QRCodeScanActivity;
import com.wbl.library.decodeImage.ImageDecodeManager;
import com.wbl.library.permission.PermissionListener;
import com.wbl.library.permission.PermissionManager;
import com.wbl.library.utils.BitmapUtil;
...
//        });
    ...
    private void identityImage() {
        ...
        decodeFormats = null;
        characterSet = null;
        ImageDecodeManager.build().setSourceImage(bt).executeDecode(new ImageDecodeManager.onDecodeFinishListener() {
            @Override
            ...
            public void fail() {
                //Log.e("TAG","解码失败");
                Toast.makeText(MainActivity.this,"解码失败",Toast.LENGTH_LONG).show();
            }
        });
    }
